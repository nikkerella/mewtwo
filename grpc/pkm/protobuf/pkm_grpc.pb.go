...
const (
	QueryService_Query_FullMethodName = "/pkm.QueryService/Query"
)
...
func (c *queryServiceClient) Query(ctx context.Context, in *QueryReq, opts ...grpc.CallOption) (*QueryResp, error) {
...
func (UnimplementedQueryServiceServer) Query(context.Context, *QueryReq) (*QueryResp, error) {
...
func _QueryService_Query_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServiceServer).Query(ctx, req.(*QueryReq))
	}
